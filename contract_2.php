...
<p>1.1.2. Организация временного размещения Заказчика и Членов семьи заказчика в Объекте размещения в дни проведения Программы: 
</p>
<p>Гостиница «Белый Лев», Республика Крым, пос.Николаевка, ул.Полевая, 7.</p>
...
<p>1.5. Организацию питания и проезда к месту оказания услуг Заказчика и Членов семьи заказчика, Заказчик осуществляет своими силами.</p>
<div class="center_text">
<h3>2. Стоимость услуг и порядок расчетов</h3>
</div>
<p>Cтоимость услуг в соответствии с п. 1.1.1 Договора: '.$data['amount'].
'('.num2str($data['amount']).').</p>
<p>Стоимость услуг в соответствии с п. 1.1.2 Договора '.$data['amount_room'].
'('.num2str($data['amount_room']).')</p>
...
<p>3.5.В случае исполнения Заказчиком обязательств по оплате услуг Исполнителя в полном объеме, в соответствии с п. 2 Договора, сумма обеспечительного платежа в подлежит возврату Заказчику, путем перечисления по реквизитам, указанным Заказчиком, или наличными денежными средствами, в течение 5 (Пяти) календарных дней, с момента поступления суммы оплаты услуг в соответствии с п. 2 Договора на расчетный счет Исполнителя.</p>
<div class="center_text">
...
<p>5.7.1 Организовать размещение Заказчика и Членов семьи заказчика в Объекте размещения, в соответствии с п. 1.1.2 Договора.</p>
...
<p>5.20 Своими силами организовать проезд к месту оказания услуг, и нести все сопутствующие расходы, в том числе расходы на питание</p>
<div class="center_text">
...
<img src="img/stamp.jpg" alt="печать" height="100">
<img src="img/signature.jpg" alt="подпись"  height="100">
<br>(печать, подпись)
</td>
<td class="td_boreder">
<b>Заказчик</b><br>
...
<p>Исполнитель 
  <img src="img/stamp.jpg" alt="печать" height="100">
  <img src="img/signature.jpg" alt="подпись"  height="100">(печать, подпись)
