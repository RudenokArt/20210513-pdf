...
<p>Стоимость услуг в соответствии с п. 1.1.2 Договора '.$data['amount_program'].
'('.num2str($data['amount_program']).')</p>
...
<div class="center_text">
<h3>5ю Права и обязанности Сторон</h3>
</div>
